...
**[VET CLINIC DATABASE]** is a project that aims to create a database for a vet clinic using postgresql
...
```sh
  cd my-folder
  git clone git@github.com:Samuelwanza/vetclinicdatabase.git
```
